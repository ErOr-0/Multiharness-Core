...
func CommandSuggestions(line string) []string {
	...
	candidates := []string{"/configuration", "/setup", "/config", "/login codex", "/login opencode", "/login claude", "/login jev", "/workspace", "/settings", "/permissions", "/new", "/save", "/load", "/diagnostics", "/options", "/help", "/quit", "/exit", "/set"}
