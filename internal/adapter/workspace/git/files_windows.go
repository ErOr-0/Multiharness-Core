...
func checkWorkspaceAccess(_ string) error {
	...
	return fmt.Errorf("%w: native Windows workflows are disabled until process-tree cancellation and terminal consent are verified; use WSL with Linux-installed Git, Codex and OpenCode", ErrUnsupported)
}
